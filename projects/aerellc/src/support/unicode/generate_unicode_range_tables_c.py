...
def generate_c_array(ranges, array_name):
    lines = [f'// Generated table for {array_name}', f'const uint32_range_t {array_name}_range_table[] = {{']
    for start, end in ranges:
        lines.append(f'    {{0x{start:X}, 0x{end:X}}},')
    lines.append('};\n')
    lines.append(f'const size_t {array_name}_range_table_count = (sizeof({array_name}_range_table)/sizeof({array_name}_range_table[0]));\n\n')
    return '\n'.join(lines)
...
if __name__ == '__main__':
    ...
    with open(ROOT_PATH + '/' + 'unicode_range_tables.c', 'w', encoding='utf-8') as f:
        f.write('// Code generated by "generate_unicode_range_tables_c.py". DO NOT EDIT.\n\n')
        f.write('#include "support/unicode/unicode_range_tables.h"\n\n')
    ...
    print('unicode_range_tables.c generated!')